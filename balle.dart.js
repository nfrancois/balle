...
"%":"ArrayBuffer|Blob|CanvasGradient|CanvasPattern|CanvasRenderingContext2D|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedNumberList|SVGAnimatedString"},
yE:{
"^":"Gv;",
...
"^":"",
Iq:[function(){var z=document.querySelector("#canvas")
$.Ee=J.uP(z)
$.q9=z.width
$.fg=z.height
C.ol.gm6(window).ml(E.nT())},"$0","KW",0,0,0],
...
a=Date.now()*0.002
y=Math.sin(H.E0(a))
x=Math.cos(H.E0(a*0.9))
w=$.Ee
w.clearRect(0,0,$.q9,$.fg)
w.fillStyle="rgb(245,245,245)"
w.fillRect(0,0,$.q9,$.fg)
w.font="bold 10px Verdana"
w.fillStyle="rgb(0,0,0)"
z="Fps : "+H.d(1000/z)
w.fillText(z,5,15)
w.beginPath()
w.fillStyle="rgb(255,0,0)"
w.arc(y*96+128,x*96+128,10,0,6.283185307179586,!0)
w.closePath()
w.fill("nonzero")
C.ol.gm6(window).ml(E.nT())},"$1","nT",2,0,1]},1],["","",,H,{
"^":"",
...
self.setImmediate(H.tR(new P.Ft(a),0))},"$1","U9",2,0,2],
...
init.metadata=[{func:"X0",void:true},{func:"c7",args:[P.FK]},{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,P.qU]},{func:"uO",args:[P.qU]},{func:"xO",args:[{func:"X0",void:true}]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},];$=null
